...
public class TicketListAdapter extends ArrayAdapter<String>{
	  ...
	  public TicketListAdapter(Context context, String[] values) {
	  ...
	  public TicketListAdapter(Context context, String[] values,
			String[] viewsDate, String[] viewsStart, String[] viewsEnd, String[] viewsId){
		  super(context, R.layout.activity_movie_details, values);
		  	this.context = context;
		    this.values = values;
	...
	@Override
	  public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    btn.setText("BOOK");
	    date.setText("Room:"+values[position]+ " Date: " +viewsDate[position]);
